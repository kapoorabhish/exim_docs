...
export class BillOfLadingController {
  constructor(private service: BillOfLadingService) {}
  ...
  @Post(':id/status')
  updateStatus(@CurrentUser() user: JwtPayload, @Param('id') id: string, @Body() body: any) {
    return this.service.updateStatus(user.tenantId, id, body.status);
  }
