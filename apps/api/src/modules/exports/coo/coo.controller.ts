...
export class CooController {
  constructor(private service: CooService) {}
  ...
  @Post(':id/status')
  transitionStatus(@CurrentUser() user: JwtPayload, @Param('id') id: string, @Body() body: any) {
    return this.service.transitionStatus(user.tenantId, id, body);
  }
